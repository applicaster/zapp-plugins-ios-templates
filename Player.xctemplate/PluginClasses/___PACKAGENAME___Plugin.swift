...
public class ___PACKAGENAME___Plugin: APPlugablePlayerBase {
    ...
    /// - Returns: Creates an instance of the player view controller and, in this example, returns a ___PACKAGENAME___Plugin instance.
    public static func pluggablePlayerInit(playableItems items: [ZPPlayable]?, configurationJSON: NSDictionary?) -> ZPPlayerProtocol? {
        ...
        let instance = ___PACKAGENAME___Plugin()
        ...
        NotificationCenter.default.addObserver(instance, selector: #selector(___PACKAGENAME___Plugin.playerDidFinishPlaying), name: Notification.Name.AVPlayerItemDidPlayToEndTime, object: nil)
    ...
    open override func pluggablePlayerType() -> ZPPlayerType {
        return ___PACKAGENAME___Plugin.pluggablePlayerType()
    }
